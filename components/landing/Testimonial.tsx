  ...
  return (
    <section className="bg-white px-6 py-20 md:py-24">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <blockquote className="text-2xl md:text-3xl font-bold text-[#22244e] leading-snug mb-8">
          &ldquo;{t.texto}&rdquo;
        </blockquote>
        <div className="flex items-center justify-center gap-3">
          <div className="w-10 h-10 rounded-full bg-[#336aea]/30 flex items-center justify-center text-lg">
            👩
          </div>
          <div className="text-left">
            {firstName && (
              <p className="font-bold text-sm text-[#22244e]">{firstName}</p>
            )}
            <p className="text-xs text-[#22244e]/50">{t.autor}</p>
          </div>
        </div>
