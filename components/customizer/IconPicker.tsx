...
export const ICONOS_NOCHE = [
  ...
  { id: "tiempo_mama",    label: "Tiempo con mamá" },
  { id: "tiempo_papa",    label: "Tiempo con papá" },
  { id: "tiempo_papa_mama", label: "Tiempo con papá y mamá" },
  { id: "juego_libre",    label: "Juego libre" },
  { id: "juego_aire_libre", label: "Juego al aire libre" },
  { id: "iglesia",        label: "Ir a la iglesia" },
  { id: "manos",          label: "Lavarse las manos" },
